...
try {
    ...
    // Liste des ID d'utilisateurs déjà pris
    $utilisateurIdsDejaPris = array_map(fn($pilote) => $pilote->getRefUtilisateur(), $pilotes);
...
<div class="container mt-5">
    <h2 class="mb-4 text-center">Ajouter un pilote</h2>
            ...
            <select class="form-select" id="ref_utilisateur" name="ref_utilisateur" required>
                ...
                <?php if (!empty($utilisateurs)): ?>
                    <?php foreach ($utilisateurs as $utilisateur): ?>
                        <?php if (!in_array($utilisateur->getIdUser(), $utilisateurIdsDejaPris)): ?>
